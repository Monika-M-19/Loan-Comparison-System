...
A Python-based desktop application developed as a college project to compare different loan options.

The project uses **Tkinter** for the graphical user interface, **SQLite** for storing loan data, and **Matplotlib** for visualizing loan comparison results.

## Features

- Compare different loan options
- Calculate loan details
- Store loan data using SQLite
- Display loan-related charts
- Desktop GUI built with Tkinter
- Modular Python files for calculation, charts, database handling, and main application logic
- Executable build setup included
